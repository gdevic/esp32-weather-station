...
ESP32 based weather station using BME280/DHT22 and Argent assembly 80422
...
It needs these additional libraries which can be installed via Arduinio IDE Library Manager:
